...
/** Evento Calendly por defecto en /gracias (personalización en el panel de Calendly). */
export const DEFAULT_CALENDLY_URL = 'https://calendly.com/andrea-kuvuapp/demo';

...
export default function App() {
  return (
    <div className="min-h-screen font-sans text-gray-900 relative">
      {/* Header */}
      <header className="absolute top-0 left-0 right-0 z-20 pt-6 pb-4">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <img src="/kuvu-logo.png" alt="KUVU Logo" className="h-20 md:h-28 object-contain" />
        </div>
      </header>

      {/* Hero Section */}
      <section className="bg-[#1976d2] text-white pt-32 pb-16 lg:pt-40 lg:pb-24 relative">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="space-y-8">
              ...
              <div>
                <a 
                  ...
                  className="inline-block bg-[#ffc107] text-gray-900 font-bold text-lg py-4 px-8 rounded-full hover:bg-yellow-400 transition-colors shadow-lg hover:shadow-xl transform hover:-translate-y-1"
                >
              ...
              <div className="pt-6 border-t border-blue-400/30">
                <ul className="space-y-3">
                  <li className="flex items-center space-x-3">
                    <CheckCircle className="w-6 h-6 text-[#ffc107]" />
                    <span className="text-blue-50 font-medium">Adiós al caos de las listas manuales</span>
                  </li>
                  <li className="flex items-center space-x-3">
                    <CheckCircle className="w-6 h-6 text-[#ffc107]" />
                    <span className="text-blue-50 font-medium">Comunicación en tiempo real sin errores</span>
                  </li>
                  <li className="flex items-center space-x-3">
                    <CheckCircle className="w-6 h-6 text-[#ffc107]" />
                    <span className="text-blue-50 font-medium">Facturación y cobros sin fricción</span>
                  </li>
                </ul>
              </div>
            </div>
            ...
            <div className="relative hidden lg:block">
              <div className="absolute inset-0 bg-blue-600 rounded-3xl transform rotate-3 scale-105 opacity-50"></div>
              <img 
                src="/mockups.png" 
                alt="Plataforma KUVU en dispositivos" 
                className="relative z-10 object-contain w-full max-h-[600px] drop-shadow-2xl"
              />
            </div>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
            <div className="flex flex-col items-center justify-center space-y-2">
              ...
              <span className="font-bold text-gray-900">100% Seguro</span>
            </div>
            <div className="flex flex-col items-center justify-center space-y-2">
              <Clock className="w-8 h-8 text-[#1976d2]" />
              <span className="font-bold text-gray-900">-15h semanales</span>
            </div>
            <div className="flex flex-col items-center justify-center space-y-2">
              <Users className="w-8 h-8 text-[#1976d2]" />
              <span className="font-bold text-gray-900">Familias felices</span>
            </div>
            <div className="flex flex-col items-center justify-center space-y-2">
              <TrendingUp className="w-8 h-8 text-[#1976d2]" />
              <span className="font-bold text-gray-900">Cero fricción</span>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-24 bg-gray-900 text-white text-center">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-xl text-gray-400 mb-10 max-w-2xl mx-auto">
            Únete a los centros educativos que ya han automatizado su gestión y mejorado la comunicación con las familias.
          </p>
          <a 
            href={WHATSAPP_LINK} 
            target="_blank" 
            rel="noopener noreferrer"
            className="inline-block bg-[#ffc107] text-gray-900 font-bold text-xl py-5 px-10 rounded-full hover:bg-yellow-400 transition-colors shadow-lg hover:shadow-xl transform hover:-translate-y-1"
          >
            SOLICITA TU DEMO GRATIS
          </a>
        </div>
